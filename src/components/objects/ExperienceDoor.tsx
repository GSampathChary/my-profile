...
function Door({ label, position, accent = "#a78bfa", onClick, open = false }: DoorProps) {
  return (
...
export function ExperienceDoor(props: Omit<DoorProps, "label">) {
  return <Door label="EXPERIENCE" {...props} />;
}
