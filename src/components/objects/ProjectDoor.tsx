...
function Door({ label, position, accent = "#7dd3fc", onClick, open = false }: DoorProps) {
  return (
...
export function ProjectDoor(props: Omit<DoorProps, "label">) {
  return <Door label="PROJECTS" {...props} />;
}
