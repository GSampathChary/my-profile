              ...
              <>
                ...
                {resumeVisible ? (
                  <ResumeBook
                    ...
                    lightsOn={lightsOn}
                    position={[-2.65, 1.295, -3.63]}
                    rotationY={-0.22}
                    scale={1}
                  />
                ) : null}
                <Phone active={focus === "phone"} onClick={onOpenPhone} position={[2.65, 1.34, -3.02]} rotationY={-0.18} scale={0.82} />
                <VisitingCard onClick={onOpenContact} position={[-3.0, 1.27, -3.12]} rotationY={-0.12} scale={0.8} />
              </>
            ) : null}
            <WallProjectsGrid
              projects={projects}
